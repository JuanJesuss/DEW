...
?>
    <p>Seleccione un departamento para mostrar sus empleados:</p>
    ...
    //seleccionamos nombre y apellidos de los empleados que pertenezcan actualmente al dpto seleccionado
    ...
    if(mysqli_num_rows($result)==0){//si no hay filas
        echo "El departamento <b>".$dpto."</b> no tiene empleados actualmente.";
    }
    else{
        echo "<p>Empleados que actualmente trabajan en el dpto <b>".$dpto."</b>:</p>
        <table>
        <tr>
        <th>Nombre</th>
        <th>Apellidos</th>
